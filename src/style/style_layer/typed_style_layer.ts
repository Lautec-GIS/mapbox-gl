...
export type TypedStyleLayer = CircleStyleLayer | FillStyleLayer | FillExtrusionStyleLayer | HeatmapStyleLayer | LineStyleLayer | SymbolStyleLayer | ModelStyleLayer | ClipStyleLayer | PieChartStyleLayer;
